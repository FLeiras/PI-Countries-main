...
export default function About() {
  return (
    <div className="container-about">
      <div className="conatiner-aboutsec">
        <div className="volver-about">
          <Link to="/home">
            <BsBoxArrowLeft className="icon-about" />
          </Link>
        </div>
        <div className="datos-text">
          ...
          <div className="about-datos">
            <span>
              ...
              para el trabajo en grupo y en equipo, amplia experiencia en
              atención al cliente, ambicioso, resiliente y motivado.
            </span>
          </div>
        </div>
